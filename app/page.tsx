      ...
      <section className="w-full px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8 flex flex-col items-center space-y-10 text-center">
        ...
        <SignedIn>
          <Link href="/dashboard">
            <button
              type="button"
              className="group relative inline-flex items-center justify-center px-8 py-3.5 text-base font-medium text-white bg-gradient-to-r from-gray-900 to-gray-800 rounded-full hover:from-gray-700 hover:to-gray-700 transition-all duration-200 shadow-lg hover:shadow-xl hover:translate-y-0.5"
            >
              Get Started
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16 pt-8 max-w-3xl mx-auto">
          {[
            ...
            { title: "Modern", description: "Next.js 15, TailwindCSS, Convex, Clerk" },
            ...
            <div key={title} className="text-center">
              ...
              <div className="text-sm text-gray-600 mt-1 tracking-wide">{description}</div>
            </div>
          ))}
        </div>
      </section>
